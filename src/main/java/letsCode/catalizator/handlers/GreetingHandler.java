...
public class GreetingHandler {
    ...
    public Mono<ServerResponse> hello (ServerRequest request) {
        //BodyInserter<String, ReactiveHttpOutputMessage> body = BodyInserters.fromValue(" Hello Valley");
        ...
        Flux<Message> data = Flux.just("Hello, reactive!",
                "More then one",
                "Third post",
                "Fourth post",
                "Fifth post").skip(start)
                .take(count).map(Message::new);
